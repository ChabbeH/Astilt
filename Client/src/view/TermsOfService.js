  ...
  return (
    <Container>
      <ContainerText>
        ...
        <h2>OVERVIEW</h2> This website is operated by TILT. Throughout the site,
        the terms “we”, “us” and “our” refer to TILT. TILT offers this website,
        ...
        acceptance of those changes. <h3>SECTION 1 - ONLINE STORE TERMS</h3> By
        ...
        termination of your Services. <h3>SECTION 2 - GENERAL CONDITIONS</h3> We
        ...
        <h3>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h3> Prices for
        our products are subject to change without notice. We reserve the right
        ...
        discontinuance of the Service. <h3>SECTION 5 - PRODUCTS OR SERVICES</h3>{" "}
        ...
        corrected.{" "}
        <h3>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h3> We
        ...
        <h3>SECTION 7 - OPTIONAL TOOLS</h3> We may provide you with access to
        third-party tools over which we neither monitor nor have any control nor
        input. You acknowledge and agree that we provide access to such tools
        ...
        third-party tools. Any use by you of optional tools offered through the
        ...
        <h3>SECTION 8 - THIRD-PARTY LINKS</h3> Certain content, products and
        ...
        <h3>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h3> If,
        ...
        <h3>SECTION 10 - PERSONAL INFORMATION</h3> Your submission of personal
        ...
        modified or updated.
        <h3>SECTION 12 - PROHIBITED USES</h3> In addition to other prohibitions
        ...
        <h3>SECTION 14 - INDEMNIFICATION</h3> You agree to indemnify, defend and
        hold harmless alibabababab-973 and our parent, subsidiaries, affiliates,
        ...
        <h3>SECTION 15 - SEVERABILITY</h3> In the event that any provision of
        ...
        <h3>SECTION 17 - ENTIRE AGREEMENT</h3> The failure of us to exercise or
        ...
        construed against the drafting party.<h3>SECTION 18 - GOVERNING LAW</h3>{" "}
        These Terms of Service and any separate agreements whereby we provide
        you Services shall be governed by and construed in accordance with the
        laws of Sweden.
        <h3>SECTION 19 - CHANGES TO TERMS OF SERVICE</h3> You can review the
        ...
        <h3>SECTION 20 - CONTACT INFORMATION</h3> Questions about the Terms of
        Service should be sent to us at info@astilt.com.
      </ContainerText>
    </Container>
  );
};
