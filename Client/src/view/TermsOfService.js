...
const LTitle = styled.h2`
  ${mobile({ fontSize: "13px", lineHeight: "19.5px" })}
`;
  ...
  return (
    <Container>
      <ContainerText>
        ...
        <LTitle>OVERVIEW</LTitle> This website is operated by TILT. Throughout
        the site, the terms “we”, “us” and “our” refer to TILT. TILT offers this
        ...
        <Stitle>SECTION 1 - ONLINE STORE TERMS</Stitle> By agreeing to these
        ...
        your consent to allow any of your minor dependents to use this site. You
        may not use our products for any illegal or unauthorized purpose nor may
        ...
        your Services. <Stitle>SECTION 2 - GENERAL CONDITIONS</Stitle> We
        ...
        <Stitle>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</Stitle>{" "}
        ...
        <Stitle>SECTION 5 - PRODUCTS OR SERVICES</Stitle> Certain products or
        ...
        <Stitle>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</Stitle>{" "}
        ...
        <Stitle>SECTION 7 - OPTIONAL TOOLS</Stitle> We may provide you with
        ...
        offered through the site is entirely at your own risk and discretion and
        you should ensure that you are familiar with and approve of the terms on
        which tools are provided by the relevant third-party provider(s). We may
        ...
        Service.
        <Stitle>SECTION 8 - THIRD-PARTY LINKS</Stitle> Certain content, products
        ...
        related to the purchase or use of goods, services, resources, content,
        or any other transactions made in connection with any third-party
        ...
        <Stitle>SECTION 10 - PERSONAL INFORMATION</Stitle> Your submission of
        personal information through the store is governed by our Privacy
        Policy. To view our Privacy Policy.{" "}
        <Stitle>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</Stitle>
        ...
        modified or updated.
        <Stitle>SECTION 12 - PROHIBITED USES</Stitle> In addition to other
        prohibitions as set forth in the Terms of Service, you are prohibited
        from using the site or its content: (a) for any unlawful purpose; (b) to
        ...
        any way that will affect the functionality or operation of the Service
        ...
        shall alibabababab-973, our directors, officers, employees, affiliates,
        ...
        <Stitle>SECTION 14 - INDEMNIFICATION</Stitle> You agree to indemnify,
        defend and hold harmless alibabababab-973 and our parent, subsidiaries,
        ...
        <Stitle>SECTION 15 - SEVERABILITY</Stitle> In the event that any
        ...
        <Stitle>SECTION 16 - TERMINATION</Stitle>
        ...
        <Stitle>SECTION 17 - ENTIRE AGREEMENT</Stitle> The failure of us to
        exercise or enforce any right or provision of these Terms of Service
        shall not constitute a waiver of such right or provision. These Terms of
        ...
        not limited to, any prior versions of the Terms of Service). Any
        ambiguities in the interpretation of these Terms of Service shall not be
        construed against the drafting party.
        <Stitle>SECTION 18 - GOVERNING LAW</Stitle> These Terms of Service and
        ...
        <Stitle>SECTION 19 - CHANGES TO TERMS OF SERVICE</Stitle> You can review
        the most current version of the Terms of Service at any time at this
        page. We reserve the right, at our sole discretion, to update, change or
        ...
        <Stitle>SECTION 20 - CONTACT INFORMATION</Stitle> Questions about the
        Terms of Service should be sent to us at info@astilt.com.
      </ContainerText>
    </Container>
  );
};
